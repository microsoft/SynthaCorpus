...
#define HAVE_64BIT_LONG_LONG 1  // Microsoft
#ifdef WIN64
typedef unsigned int u_int; // Microsoft
typedef unsigned long long u_int64_t; // Microsoft
#endif
...
typedef struct {
	u_int w32[2]; /* w32[0] is low order, w32[1] is high order word */
} Fnv64_t;
...
#define HAVE_64BIT_LONG_LONG 1   // Inserted by Microsoft
